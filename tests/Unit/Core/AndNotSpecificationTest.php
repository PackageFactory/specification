...
use PackageFactory\Specification\Core\AndNotSpecification;
...
final class AndNotSpecificationTest extends TestCase
{
    ...
    {
        $andNotSpecification = new AndNotSpecification($left, $right);

        $this->assertEquals($expectedResult, $andNotSpecification->isSatisfiedBy('AnyValue'));
    }
}
