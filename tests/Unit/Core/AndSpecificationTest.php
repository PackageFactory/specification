...
use PackageFactory\Specification\Core\AndSpecification;
...
final class AndSpecificationTest extends TestCase
{
    ...
    {
        $andSpecification = new AndSpecification($left, $right);

        $this->assertEquals($expectedResult, $andSpecification->isSatisfiedBy('AnyValue'));
    }
}
