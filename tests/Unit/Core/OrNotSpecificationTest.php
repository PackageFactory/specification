...
use PackageFactory\Specification\Core\OrNotSpecification;
...
final class OrNotSpecificationTest extends TestCase
{
    ...
    {
        $orNotSpecification = new OrNotSpecification($left, $right);

        $this->assertEquals($expectedResult, $orNotSpecification->isSatisfiedBy('AnyValue'));
    }
}
